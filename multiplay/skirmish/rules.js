...
function eventGameInit()
{
	...
	for (var playnum = 0; playnum < maxPlayers; playnum++)
	{
		...
		setStructureLimits("A0CannonTower", 1000, playnum);
		setStructureLimits("A0FacMod1", 1000, playnum);
		setStructureLimits("A0HardcreteMk1CWall", 1000, playnum);
		setStructureLimits("A0HardcreteMk1Gate", 1000, playnum);
		setStructureLimits("A0HardcreteMk1Wall", 1000, playnum);
		setStructureLimits("A0PowMod1", 1000, playnum);
		setStructureLimits("A0RepairCentre3", 10, playnum);
		setStructureLimits("A0ResearchModule1", 1000, playnum);
		setStructureLimits("A0ResourceExtractor", 1000, playnum);
		setStructureLimits("A0Sat-linkCentre", 1000, playnum);
		setStructureLimits("A0TankTrap", 1000, playnum);
		setStructureLimits("A0VtolPad", 1000, playnum);
		setStructureLimits("AASite-QuadBof", 1000, playnum);
		setStructureLimits("AASite-QuadMg1", 1000, playnum);
		setStructureLimits("AASite-QuadRotMg", 1000, playnum);
		setStructureLimits("ECM1PylonMk1", 1000, playnum);
		setStructureLimits("Emplacement-HPVcannon", 1000, playnum);
		setStructureLimits("Emplacement-HeavyLaser", 1000, playnum);
		setStructureLimits("Emplacement-Howitzer-Incenediary", 1000, playnum);
		setStructureLimits("Emplacement-Howitzer105", 1000, playnum);
		setStructureLimits("Emplacement-Howitzer150", 1000, playnum);
		setStructureLimits("Emplacement-HvART-pit", 1000, playnum);
		setStructureLimits("Emplacement-HvyATrocket", 1000, playnum);
		setStructureLimits("Emplacement-MRL-pit", 1000, playnum);
		setStructureLimits("Emplacement-MdART-pit", 1000, playnum);
		setStructureLimits("Emplacement-MortarEMP", 1000, playnum);
		setStructureLimits("Emplacement-MortarPit-Incenediary", 1000, playnum);
		setStructureLimits("Emplacement-MortarPit01", 1000, playnum);
		setStructureLimits("Emplacement-MortarPit02", 1000, playnum);
		setStructureLimits("Emplacement-PlasmaCannon", 1000, playnum);
		setStructureLimits("Emplacement-PrisLas", 1000, playnum);
		setStructureLimits("Emplacement-PulseLaser", 1000, playnum);
		setStructureLimits("Emplacement-Rail2", 1000, playnum);
		setStructureLimits("Emplacement-Rail3", 1000, playnum);
		setStructureLimits("Emplacement-Rocket06-IDF", 1000, playnum);
		setStructureLimits("Emplacement-RotHow", 1000, playnum);
		setStructureLimits("Emplacement-RotMor", 1000, playnum);
		setStructureLimits("GuardTower-ATMiss", 1000, playnum);
		setStructureLimits("GuardTower-BeamLas", 1000, playnum);
		setStructureLimits("GuardTower-Rail1", 1000, playnum);
		setStructureLimits("GuardTower-RotMg", 1000, playnum);
		setStructureLimits("GuardTower1", 1000, playnum);
		setStructureLimits("GuardTower2", 1000, playnum);
		setStructureLimits("GuardTower3", 1000, playnum);
		setStructureLimits("GuardTower4", 1000, playnum);
		setStructureLimits("GuardTower5", 1000, playnum);
		setStructureLimits("GuardTower6", 1000, playnum);
		setStructureLimits("LookOutTower", 1000, playnum);
		setStructureLimits("P0-AASite-Laser", 1000, playnum);
		setStructureLimits("P0-AASite-SAM1", 1000, playnum);
		setStructureLimits("P0-AASite-SAM2", 1000, playnum);
		setStructureLimits("P0-AASite-Sunburst", 1000, playnum);
		setStructureLimits("PillBox-Cannon6", 1000, playnum);
		setStructureLimits("PillBox1", 1000, playnum);
		setStructureLimits("PillBox2", 1000, playnum);
		setStructureLimits("PillBox3", 1000, playnum);
		setStructureLimits("PillBox4", 1000, playnum);
		setStructureLimits("PillBox5", 1000, playnum);
		setStructureLimits("PillBox6", 1000, playnum);
		setStructureLimits("Pillbox-RotMG", 1000, playnum);
		setStructureLimits("Plasmite-flamer-bunker", 1000, playnum);
		setStructureLimits("Sys-CB-Tower01", 1000, playnum);
		setStructureLimits("Sys-RadarDetector01", 1000, playnum);
		setStructureLimits("Sys-SensoTower01", 1000, playnum);
		setStructureLimits("Sys-SensoTower02", 1000, playnum);
		setStructureLimits("Sys-SensoTowerWS", 1000, playnum);
		setStructureLimits("Sys-SpyTower", 1000, playnum);
		setStructureLimits("Sys-VTOL-CB-Tower01", 1000, playnum);
		setStructureLimits("Sys-VTOL-RadarTower01", 1000, playnum);
		setStructureLimits("TankTrapC", 1000, playnum);
		setStructureLimits("Tower-Projector", 1000, playnum);
		setStructureLimits("Tower-RotMg", 1000, playnum);
		setStructureLimits("Tower-VulcanCan", 1000, playnum);
		setStructureLimits("Wall-RotMg", 1000, playnum);
		setStructureLimits("Wall-VulcanCan", 1000, playnum);
		setStructureLimits("WallTower-Atmiss", 1000, playnum);
		setStructureLimits("WallTower-DoubleAAGun", 1000, playnum);
		setStructureLimits("WallTower-EMP", 1000, playnum);
		setStructureLimits("WallTower-HPVcannon", 1000, playnum);
		setStructureLimits("WallTower-HvATrocket", 1000, playnum);
		setStructureLimits("WallTower-Projector", 1000, playnum);
		setStructureLimits("WallTower-PulseLas", 1000, playnum);
		setStructureLimits("WallTower-QuadRotAAGun", 1000, playnum);
		setStructureLimits("WallTower-Rail2", 1000, playnum);
		setStructureLimits("WallTower-Rail3", 1000, playnum);
		setStructureLimits("WallTower-SamHvy", 1000, playnum);
		setStructureLimits("WallTower-SamSite", 1000, playnum);
		setStructureLimits("WallTower-TwinAssaultGun", 1000, playnum);
		setStructureLimits("WallTower01", 1000, playnum);
		setStructureLimits("WallTower02", 1000, playnum);
		setStructureLimits("WallTower03", 1000, playnum);
		setStructureLimits("WallTower04", 1000, playnum);
		setStructureLimits("WallTower05", 1000, playnum);
		setStructureLimits("WallTower06", 1000, playnum);
		setStructureLimits("X-Super-Cannon", 1000, playnum);
		setStructureLimits("X-Super-MassDriver", 1000, playnum);
		setStructureLimits("X-Super-Missile", 1000, playnum);
		setStructureLimits("X-Super-Rocket", 1000, playnum);
	}
